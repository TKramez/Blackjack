		...
		while (!bust) {
			...
			while (!bust) {
				if (this.getHand().getPoints() > 21) {
					...
					bust = true;
				} else if (((this.getHand().getPoints() >= 17) && !this
						.getHand().hasAce())
						|| ((this.getHand().getPoints() > 17) && this.getHand()
								.hasAce()))
					bust = true;
				else if ((this.getHand().getRawPoints() > this.getHand()
						.getPoints()) && (this.getHand().getPoints() >= 17))
					bust = true;
				else {
					Card draw;
